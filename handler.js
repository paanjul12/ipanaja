        ...
        for (let name in global.plugins) {
            ...
            if ((usedPrefix = (match[0] || '')[0])) {
                ...
                try {
                    ...
                    if (m.diamond)
                        m.reply(`Telah di gunakan *${+m.diamond}* 💎`)
                }
                break
            }
        }
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        mods: '🔰  Perintah ini khusus moderator bot !',
        premium: '💠 Perintah ini hanya untuk anggota *Premium*\n\nKetik *.premium* untuk info lebih lanjut',
        group: '⚙️ Perintah ini hanya dapat digunakan dalam grup!',
        private: '📮 Perintah ini hanya dapat digunakan dalam chat pribadi',
        admin: '🛡️ Perintah ini khusus Admin Group !',
        botAdmin: '💥 Perintah bekerja ketika bot menjadi admin !',
        unreg: '📇 Daftar untuk menggunakan fungsi ini dengan Mengetik:\n\n*.reg name.umur*\n\n📌Contoh : *.reg Ipan.18*',
